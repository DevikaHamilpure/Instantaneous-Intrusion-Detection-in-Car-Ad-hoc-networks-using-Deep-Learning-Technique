...
def pre():
        ...
        messagebox.showinfo("Intr","Training samples: (395216, 41), Testing samples: (98804, 41)")
def cnn():
    # -------------------- Data Preprocessing --------------------
    import pandas as pd
    import numpy as np
    ...
    rnn_model.fit(X_train_dl, y_train, epochs=10, batch_size=128, validation_data=(X_test_dl, y_test))
...
Button(root, text='Load Dataset', width=20, bg='yellow', fg='black',  font=("bold", 12),command=Load).place(x=300, y=400)
Button(root, text='Preprocessing', width=20, bg='yellow', fg='black',  font=("bold", 12),command=pre).place(x=300, y=450)
Button(root, text='CNN + RNN', width=20, bg='yellow', fg='black',  font=("bold", 12),command=cnn).place(x=300, y=500)
Button(root, text='Real Time Intrusion', width=20, bg='yellow', fg='black',  font=("bold", 12),command=detect).place(x=300, y=550)
root.mainloop()
